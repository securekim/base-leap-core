...
describe('helpers', () => {
  ...
  const SC_TokenID = 12345;
  const depositState1 = Tx.depositState(0x111, ADDR_2, ADDR_1, SC_TokenID);
  const unspentState = [
  ...
  describe('formSCInputs',() => {
    it('should return inputs with exact parameter', () => {
      const inputs1 = formSCInputs(unspentState, ADDR_1, ADDR_2, '0x101', SC_TokenID);
  ...
  describe('formSCOutputs', () => {
    it('sholud return outputs with exact parameter', () => {
      const inputs1 = formSCInputs(unspentState, ADDR_1, ADDR_2, '0x101', SC_TokenID);
      const outputs1 = formSCOutputs(unspentState, inputs1, ADDR_1, ADDR_2, SC_TokenID);
